...
export default class extends think.service.base {
    ...
    async build(buildInfo, logFile, username, isNpmInstall, isInc, incExc, sync) {
        ...
        console.log(build_shell, buildDir, task, buildInfo.pro_id, isNpmInstall,process.cwd());
        ///执行build_hook before
        ...
        if (sync) {
            ...
            const pro = childProcessPro.spawn('sh', [build_shell, buildDir, task, buildInfo.pro_id, isNpmInstall,process.cwd()]);
